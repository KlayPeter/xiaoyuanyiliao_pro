<template>
	...
	<view>
		<form @submit="xyyiliaoyhUpdateGuahaozixunjieguoactJson">
...
<script>
	export default {
		...
		methods: {
			xyyiliaoyhUpdateGuahaozixunjieguoactJson(e) {
				let _this = this
				uni.request({
					url: "xyyiliaoyhUpdateGuahaozixunjieguoactJson",
					method: "POST",
		...
		onLoad(e) {
			...
			console.log(e)
			uni.request({
				url: "xyyiliaoyhUpdateGuahaozixunjieguoJson?id=" + e.id,
				success: res => {
