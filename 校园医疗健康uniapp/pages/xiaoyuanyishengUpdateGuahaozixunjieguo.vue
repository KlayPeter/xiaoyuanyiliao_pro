<template>
	...
	<view>
		<form @submit="xiaoyuanyishengUpdateGuahaozixunjieguoactJson">
...
<script>
	export default {
		...
		methods: {
			xiaoyuanyishengUpdateGuahaozixunjieguoactJson(e) {
				let _this = this
				uni.request({
					url: "xiaoyuanyishengUpdateGuahaozixunjieguoactJson",
					method: "POST",
		...
		onLoad(e) {
			...
			console.log(e)
			uni.request({
				url: "xiaoyuanyishengUpdateGuahaozixunjieguoJson?id=" + e.id,
				success: res => {
