<template>
	...
	<view>
		<form @submit="xiaoyuanyishengUpdateXytijianshixiangactJson">
...
<script>
	export default {
		...
		methods: {
			...
			xiaoyuanyishengUpdateXytijianshixiangactJson(e) {
				let _this = this
				uni.request({
					url: "xiaoyuanyishengUpdateXytijianshixiangactJson",
					method: "POST",
		...
		onLoad(e) {
			...
			console.log(e)
			uni.request({
				url: "xiaoyuanyishengUpdateXytijianshixiangJson?id=" + e.id,
				success: res => {
