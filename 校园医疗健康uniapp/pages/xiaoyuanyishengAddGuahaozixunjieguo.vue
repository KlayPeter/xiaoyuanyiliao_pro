<template>
	...
	<view>
		<form @submit="xiaoyuanyishengAddGuahaozixunjieguoactJson">
...
<script>
	export default {
		...
		methods: {
			...
			xiaoyuanyishengAddGuahaozixunjieguoactJson(e) {
				let _this = this
				uni.request({
					url: "xiaoyuanyishengAddGuahaozixunjieguoactJson",
					method: "POST",
		...
		onLoad(e) {
			...
			uni.request({
				url:"xiaoyuanyishengAddGuahaozixunjieguoJson",
				method:"POST",
				success(res) {
				}
			})
			var userinfo = uni.getStorageSync("userinfo")
			_this.guahaozixunjieguo.xiaoyuanyishengid =  userinfo.id
			_this.guahaozixunjieguo.xiaoyuanyisheng = userinfo.username
