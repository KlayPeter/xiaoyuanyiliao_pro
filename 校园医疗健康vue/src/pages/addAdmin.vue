    ...
    <div class="anime-card">
      ...
      <el-form label-width="100px" class="form">
        ...
        <el-form-item class="form-footer">
          <el-button type="primary" size="large" class="anime-btn" @click="addAdminactJson()">
            ✨ 添加
          </el-button>
...
<script>
  const addAdmin = {
    ...
    methods: {
      ...
      addAdminactJson() {
        var _this = this
        this.axios.post("/addAdminactJson", _this.admin).then(res => {
          if (res.data.message == '添加管理员成功') {
            _this.$toast.success("添加管理员成功",{
              position: "top",
              pauseOnHover: false,
              duration: 2000
            })
    ...
    created() {
      var _this = this
      this.axios.post("/addAdminJson").then(res=>{
      })
    },
    //可以操作dom了
    mounted() {
