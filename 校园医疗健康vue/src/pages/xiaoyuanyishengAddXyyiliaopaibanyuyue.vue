<template>
    <div class="anime-page">
        <div class="anime-card">
            <h2 class="page-header">添加校园医疗排班预约</h2>
            <el-form label-width="100px" class="form">
                ...
                <el-form-item class="form-footer">
                    <el-button type="primary" size="large" class="anime-btn" @click="xiaoyuanyishengAddXyyiliaopaibanyuyueactJson">
                        ✨ 添加
                    </el-button>
...
<script>
  const xiaoyuanyishengAddXyyiliaopaibanyuyue = {
    components: {
    ...
    methods: {
      ...
      xiaoyuanyishengAddXyyiliaopaibanyuyueactJson() {
        var _this = this
        this.axios.post("/xiaoyuanyishengAddXyyiliaopaibanyuyueactJson", _this.xyyiliaopaibanyuyue).then(res => {
          if (res.data.message == '添加校园医疗排班预约成功') {
            _this.$toast.success("添加校园医疗排班预约成功",{
              position: "top",
              pauseOnHover: false,
              duration: 2000
            })
            _this.$router.push({path:"/htMenu/xiaoyuanyishengxyyiliaopaibanyuyueList"})
            return
          }else {
    ...
    created() {
      ...
      this.xyyiliaopaibanyuyue.xiaoyuanyishengid = userinfo.id
      this.xyyiliaopaibanyuyue.xiaoyuanyisheng = userinfo.username
      this.axios.post("/xiaoyuanyishengAddXyyiliaopaibanyuyueJson").then(res=>{
  ...
  export default xiaoyuanyishengAddXyyiliaopaibanyuyue
</script>
<style scoped>
    /* 表单外观 - 椭圆背景 */
    .form {
