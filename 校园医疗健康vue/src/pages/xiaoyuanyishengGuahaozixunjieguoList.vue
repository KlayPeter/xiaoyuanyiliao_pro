<template>
  <div class="anime-page">
    ...
    <div class="search-area">
      ...
      <el-button type="primary" @click="xiaoyuanyishengGuahaozixunjieguoListJson()">搜索</el-button>
    </div>
...
<!--          <el-button type="primary" plain size="small" @click.prevent="toXiaoyuanyishengUpdateGuahaozixunjieguo(scope.row.id)"-->
<!--          >修改</el-button>-->
<!--          <el-button type="danger" plain size="small"-->
<!--                     @click.prevent="xiaoyuanyishengDeleteGuahaozixunjieguoJson(scope.row.id)"-->
<!--          >删除</el-button>-->
<!--        </template>-->
<!--      </el-table-column>-->
    </el-table>
...
<script>
  const xiaoyuanyishengGuahaozixunjieguoList = {
    components: {
    },
    data() {
      return {
    ...
    methods: {
      xiaoyuanyishengDeleteGuahaozixunjieguoJson(id) {
        var _this = this
        console.log(id)
        this.axios.post("/xiaoyuanyishengDeleteGuahaozixunjieguoJson?id=" + id, {}).then(res => {
      ...
      toXiaoyuanyishengUpdateGuahaozixunjieguo(id) {
        this.$router.push({path:"/htMenu/xiaoyuanyishengUpdateGuahaozixunjieguo",query:{id:id}})
      },
      xiaoyuanyishengGuahaozixunjieguoListJson() {
        var _this = this
        this.axios.post("/xiaoyuanyishengGuahaozixunjieguoListJson?search="+this.search,{}).then(res => {
    ...
    created() {
      var _this = this
      this.xiaoyuanyishengGuahaozixunjieguoListJson()
    },
    //可以操作dom了
    mounted() {
  ...
  export default xiaoyuanyishengGuahaozixunjieguoList
</script>
