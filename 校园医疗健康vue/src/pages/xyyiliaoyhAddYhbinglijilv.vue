        ...
        <div class="anime-card">
            ...
            <el-form label-width="100px" class="form">
                ...
                <el-form-item class="form-footer">
                    <el-button type="primary" size="large" class="anime-btn" @click="xyyiliaoyhAddYhbinglijilvactJson">
                        ✨ 添加
                    </el-button>
...
<script>
  const xyyiliaoyhAddYhbinglijilv = {
    components: {
    ...
    methods: {
      ...
      xyyiliaoyhAddYhbinglijilvactJson() {
        var _this = this
        this.axios.post("/xyyiliaoyhAddYhbinglijilvactJson", _this.yhbinglijilv).then(res => {
    ...
    created() {
      ...
      this.yhbinglijilv.xyyiliaoyhid = userinfo.id
      this.yhbinglijilv.xyyiliaoyh = userinfo.username
      this.axios.post("/xyyiliaoyhAddYhbinglijilvJson").then(res=>{
      })
    },
    //可以操作dom了
    mounted() {
  ...
  export default xyyiliaoyhAddYhbinglijilv
</script>
<style scoped>
    /* 表单外观 - 椭圆背景 */
    .form {
