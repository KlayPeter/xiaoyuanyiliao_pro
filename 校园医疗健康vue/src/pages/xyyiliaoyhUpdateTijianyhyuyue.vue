        ...
        <div class="anime-card">
            ...
            <el-form label-width="100px" class="form">
                ...
                <el-form-item class="form-footer">
                    <el-button type="primary" size="large" class="anime-btn" @click="xyyiliaoyhUpdateTijianyhyuyueactJson()">
                        ✨ 修改
                    </el-button>
...
<script>
  const xyyiliaoyhUpdateTijianyhyuyue = {
    components: {
    },
    data() {
      return {
    ...
    methods: {
      ...
      xyyiliaoyhUpdateTijianyhyuyueactJson() {
        var _this = this

        this.axios.post("/xyyiliaoyhUpdateTijianyhyuyueactJson", _this.tijianyhyuyue).then(res => {
    ...
    created() {
      var _this = this
      this.axios.post("/xyyiliaoyhUpdateTijianyhyuyueJson?id="+this.$route.query.id,).then(res=>{
  ...
  export default xyyiliaoyhUpdateTijianyhyuyue
</script>
<style scoped>
