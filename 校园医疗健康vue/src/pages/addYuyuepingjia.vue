    ...
    <div class="anime-card">
      ...
      <el-form label-width="100px" class="form">
        ...
        <el-form-item class="form-footer">
          <el-button type="primary" size="large" class="anime-btn" @click="addYuyuepingjiaactJson()">
            ✨ 添加
          </el-button>
...
<script>
  const addYuyuepingjia = {
    ...
    methods: {
      ...
      addYuyuepingjiaactJson() {
        var _this = this
        this.axios.post("/addYuyuepingjiaactJson", _this.yuyuepingjia).then(res => {
    ...
    created() {
      var _this = this
      this.axios.post("/addYuyuepingjiaJson").then(res=>{
      })
    },
    //可以操作dom了
    mounted() {
  ...
  export default addYuyuepingjia
</script>
<style scoped>
