        ...
        <div class="anime-card">
            ...
            <el-form label-width="100px" class="form">
                ...
                <el-form-item class="form-footer">
                    <el-button type="primary" size="large" class="anime-btn" @click="xyyiliaoyhUpdateYuyuepingjiaactJson()">
                        ✨ 修改
                    </el-button>
...
<script>
  const xyyiliaoyhUpdateYuyuepingjia = {
    components: {
    },
    data() {
      return {
    ...
    methods: {
      ...
      xyyiliaoyhUpdateYuyuepingjiaactJson() {
        var _this = this

        this.axios.post("/xyyiliaoyhUpdateYuyuepingjiaactJson", _this.yuyuepingjia).then(res => {
    ...
    created() {
      var _this = this
      this.axios.post("/xyyiliaoyhUpdateYuyuepingjiaJson?id="+this.$route.query.id,).then(res=>{
  ...
  export default xyyiliaoyhUpdateYuyuepingjia
</script>
<style scoped>
    /* 表单外观 - 椭圆背景 */
    .form {
