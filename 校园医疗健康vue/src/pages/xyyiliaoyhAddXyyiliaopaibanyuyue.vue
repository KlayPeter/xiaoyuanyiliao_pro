        ...
        <div class="anime-card">
            ...
            <el-form label-width="100px" class="form">
                ...
                <el-form-item class="form-footer">
                    <el-button type="primary" size="large" class="anime-btn" @click="xyyiliaoyhAddXyyiliaopaibanyuyueactJson">
                        ✨ 添加
                    </el-button>
...
<script>
  const xyyiliaoyhAddXyyiliaopaibanyuyue = {
    components: {
    ...
    methods: {
      ...
      xyyiliaoyhAddXyyiliaopaibanyuyueactJson() {
        var _this = this
        this.axios.post("/xyyiliaoyhAddXyyiliaopaibanyuyueactJson", _this.xyyiliaopaibanyuyue).then(res => {
    ...
    created() {
      ...
      this.xyyiliaopaibanyuyue.xyyiliaoyhid = userinfo.id
      this.xyyiliaopaibanyuyue.xyyiliaoyh = userinfo.username
      this.axios.post("/xyyiliaoyhAddXyyiliaopaibanyuyueJson").then(res=>{
  ...
  export default xyyiliaoyhAddXyyiliaopaibanyuyue
</script>
<style scoped>
    /* 表单外观 - 椭圆背景 */
    .form {
