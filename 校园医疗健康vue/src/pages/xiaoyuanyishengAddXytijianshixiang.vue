        ...
        <div class="anime-card">
            ...
            <el-form label-width="100px" class="form">
                ...
                <el-form-item class="form-footer">
                    <el-button type="primary" size="large" class="anime-btn" @click="xiaoyuanyishengAddXytijianshixiangactJson">
                        ✨ 添加
                    </el-button>
...
<script>
  const xiaoyuanyishengAddXytijianshixiang = {
    components: {
    ...
    methods: {
      ...
      xiaoyuanyishengAddXytijianshixiangactJson() {
        var _this = this
        this.axios.post("/xiaoyuanyishengAddXytijianshixiangactJson", _this.xytijianshixiang).then(res => {
    ...
    created() {
      ...
      this.xytijianshixiang.xiaoyuanyishengid = userinfo.id
      this.xytijianshixiang.xiaoyuanyisheng = userinfo.username
      this.axios.post("/xiaoyuanyishengAddXytijianshixiangJson").then(res=>{
      })
    },
    //可以操作dom了
    mounted() {
  ...
  export default xiaoyuanyishengAddXytijianshixiang
</script>
<style scoped>
    /* 表单外观 - 椭圆背景 */
    .form {
