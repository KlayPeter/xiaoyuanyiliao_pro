    ...
    <div class="anime-card">
      ...
      <el-form label-width="100px" class="form">
        ...
        <el-form-item class="form-footer">
          <el-button type="primary" size="large" class="anime-btn" @click="addGuahaozixunjieguoactJson()">
            ✨ 添加
          </el-button>
...
<script>
  const addGuahaozixunjieguo = {
    ...
    methods: {
      ...
      addGuahaozixunjieguoactJson() {
        var _this = this
        this.axios.post("/addGuahaozixunjieguoactJson", _this.guahaozixunjieguo).then(res => {
    ...
    created() {
      var _this = this
      this.axios.post("/addGuahaozixunjieguoJson").then(res=>{
      })
    },
    //可以操作dom了
    mounted() {
  ...
  export default addGuahaozixunjieguo
</script>
<style scoped>
