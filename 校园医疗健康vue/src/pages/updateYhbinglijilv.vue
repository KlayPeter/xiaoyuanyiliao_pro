    ...
    <div class="anime-card">
      ...
      <el-form label-width="100px" class="form">
        ...
        <el-form-item class="form-footer">
          <el-button type="primary" size="large" class="anime-btn" @click="updateYhbinglijilvactJson()">
            ✨ 修改
          </el-button>
...
<script>
  const updateYhbinglijilv = {
    ...
    methods: {
      ...
      updateYhbinglijilvactJson() {
        var _this = this
        this.axios.post("/updateYhbinglijilvactJson", _this.yhbinglijilv).then(res => {
    ...
    created() {
      var _this = this
      this.axios.post("/updateYhbinglijilvJson?id="+_this.$route.query.id).then(res=>{
  ...
  export default updateYhbinglijilv
</script>
<style scoped>
  /* 表单外观 - 椭圆背景 */
  .form {
