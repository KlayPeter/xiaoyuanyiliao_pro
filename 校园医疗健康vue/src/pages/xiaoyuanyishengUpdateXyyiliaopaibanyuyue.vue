        ...
        <div class="anime-card">
            ...
            <el-form label-width="100px" class="form">
                ...
                <el-form-item class="form-footer">
                    <el-button type="primary" size="large" class="anime-btn" @click="xiaoyuanyishengUpdateXyyiliaopaibanyuyueactJson()">
                        ✨ 修改
                    </el-button>
...
<script>
  const xiaoyuanyishengUpdateXyyiliaopaibanyuyue = {
    components: {
    },
    data() {
      return {
    ...
    methods: {
      ...
      xiaoyuanyishengUpdateXyyiliaopaibanyuyueactJson() {
        var _this = this

        this.axios.post("/xiaoyuanyishengUpdateXyyiliaopaibanyuyueactJson", _this.xyyiliaopaibanyuyue).then(res => {
    ...
    created() {
      var _this = this
      this.axios.post("/xiaoyuanyishengUpdateXyyiliaopaibanyuyueJson?id="+this.$route.query.id,).then(res=>{
  ...
  export default xiaoyuanyishengUpdateXyyiliaopaibanyuyue
</script>
<style scoped>
