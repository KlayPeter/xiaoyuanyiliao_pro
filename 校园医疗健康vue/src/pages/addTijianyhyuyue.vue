    ...
    <div class="anime-card">
      ...
      <el-form label-width="100px" class="form">
        ...
        <el-form-item class="form-footer">
          <el-button type="primary" size="large" class="anime-btn" @click="addTijianyhyuyueactJson()">
            ✨ 添加
          </el-button>
...
<script>
  const addTijianyhyuyue = {
    ...
    methods: {
      ...
      addTijianyhyuyueactJson() {
        var _this = this
        this.axios.post("/addTijianyhyuyueactJson", _this.tijianyhyuyue).then(res => {
    ...
    created() {
      var _this = this
      this.axios.post("/addTijianyhyuyueJson").then(res=>{
  ...
  export default addTijianyhyuyue
</script>
<style scoped>
  /* 表单外观 - 椭圆背景 */
  .form {
