        ...
        <div class="anime-card">
            ...
            <el-form label-width="100px" class="form">
                ...
                <el-form-item class="form-footer">
                    <el-button type="primary" size="large" class="anime-btn" @click="xiaoyuanyishengUpdateGuahaozixunjieguoactJson()">
                        ✨ 修改
                    </el-button>
...
<script>
  const xiaoyuanyishengUpdateGuahaozixunjieguo = {
    components: {
    },
    data() {
      return {
    ...
    methods: {
      ...
      xiaoyuanyishengUpdateGuahaozixunjieguoactJson() {
        var _this = this

        this.axios.post("/xiaoyuanyishengUpdateGuahaozixunjieguoactJson", _this.guahaozixunjieguo).then(res => {
    ...
    created() {
      var _this = this
      this.axios.post("/xiaoyuanyishengUpdateGuahaozixunjieguoJson?id="+this.$route.query.id,).then(res=>{
  ...
  export default xiaoyuanyishengUpdateGuahaozixunjieguo
</script>
<style scoped>
    /* 表单外观 - 椭圆背景 */
    .form {
