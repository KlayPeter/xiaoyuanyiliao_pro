<template>
  <div class="anime-page">
    <div class="anime-card">
      <h2 class="page-header">修改校园医生</h2>
              ...
              <div class="avatar-frame">
                ...
                >
                  <div class="img-uploader-content">
                    ...
                    <template v-else>
                      <img
                              :src="'http://localhost:8080/xiaoyuanyiliaojiankang/static/upload/' + xiaoyuanyisheng.schoolysavaator"
                              alt="上传图片"
                              class="preview-img"
                      />
                    </template>
...
<!--              <el-input placeholder="请输入医生简介" v-model="xiaoyuanyisheng.schoolysjianjie" type="textarea" clearable />-->
        ...
        <el-form-item class="form-footer">
          <el-button type="primary" size="large" class="anime-btn" @click="updateXiaoyuanyishengactJson()">
            ✨ 修改
          </el-button>
...
<script>
  ...
  const updateXiaoyuanyisheng = {
    ...
    methods: {
      ...
      updateXiaoyuanyishengactJson() {
        var _this = this
        this.axios.post("/updateXiaoyuanyishengactJson", _this.xiaoyuanyisheng).then(res => {
          if (res.data.message == '修改校园医生成功') {
            _this.$toast.success("修改校园医生成功",{
              position: "top",
              pauseOnHover: false,
              duration: 2000
            })
    ...
    created() {
      var _this = this
      this.axios.post("/updateXiaoyuanyishengJson?id="+_this.$route.query.id).then(res=>{
  ...
  export default updateXiaoyuanyisheng
</script>
<style scoped>
  /* 表单外观 - 椭圆背景 */
  .form {
