        ...
        <div class="anime-card">
            ...
            <el-form label-width="100px" class="form">
                ...
                <el-form-item class="form-footer">
                    <el-button type="primary" size="large" class="anime-btn" @click="xyyiliaoyhUpdateGuahaozixunjieguoactJson()">
                        ✨ 修改
                    </el-button>
...
<script>
  const xyyiliaoyhUpdateGuahaozixunjieguo = {
    components: {
    },
    data() {
      return {
    ...
    methods: {
      ...
      xyyiliaoyhUpdateGuahaozixunjieguoactJson() {
        var _this = this

        this.axios.post("/xyyiliaoyhUpdateGuahaozixunjieguoactJson", _this.guahaozixunjieguo).then(res => {
    ...
    created() {
      var _this = this
      this.axios.post("/xyyiliaoyhUpdateGuahaozixunjieguoJson?id="+this.$route.query.id,).then(res=>{
  ...
  export default xyyiliaoyhUpdateGuahaozixunjieguo
</script>
<style scoped>
    /* 表单外观 - 椭圆背景 */
    .form {
