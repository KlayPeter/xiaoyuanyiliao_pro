    ...
    <div class="anime-card">
      ...
      <el-form label-width="100px" class="form">
        ...
        <el-form-item class="form-footer">
          <el-button type="primary" size="large" class="anime-btn" @click="addXyyiliaopaibanyuyueactJson()">
            ✨ 添加
          </el-button>
...
<script>
  const addXyyiliaopaibanyuyue = {
    ...
    methods: {
      ...
      addXyyiliaopaibanyuyueactJson() {
        var _this = this
        this.axios.post("/addXyyiliaopaibanyuyueactJson", _this.xyyiliaopaibanyuyue).then(res => {
    ...
    created() {
      var _this = this
      this.axios.post("/addXyyiliaopaibanyuyueJson").then(res=>{
  ...
  export default addXyyiliaopaibanyuyue
</script>
<style scoped>
  /* 表单外观 - 椭圆背景 */
  .form {
