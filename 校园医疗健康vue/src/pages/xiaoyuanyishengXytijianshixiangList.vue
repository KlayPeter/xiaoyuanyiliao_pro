  ...
  <div class="anime-page">
    ...
    <el-table :data="showXytijianshixiangArr" stripe style="width: 100%;" height="600px" class="anime-table">
          ...
          <el-table-column prop="tijianimg" label="封面" min-width="100">
            <template #default="scope">
              <div class="avatar-frame">
                <img :src="'http://localhost:8080/xiaoyuanyiliaojiankang/static/upload/'+scope.row.tijianimg" alt="封面" />
              </div>
            </template>
          </el-table-column>
      ...
      <el-table-column fixed="right" label="操作" min-width="120">
        <template #default="scope">
          <el-button class="anime-btn" size="small" @click.prevent="chakanjutiyuyue(scope.row.id)"
          >查看具体预约</el-button>
        </template>
      </el-table-column>
    </el-table>
